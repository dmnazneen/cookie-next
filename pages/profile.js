...
const Profile = () => {
    ...
    const preview = () => {
        ...
        // const displayPic = document.getElementById('userpic');
        // displayPic.src = URL.createObjectURL(pic);
        console.log('hit')
    }
    return (
            ...
            <div className='h-full overflow-y-scroll'>
                <div className='w-[560px] mx-auto font-semibold'>
                    ...
                    <div className='flex gap-4 items-center'>
                        <Image id='userpic' priority={true} src={user} alt='picture of the current user' height={100} width={100} className='rounded-full' />
                        <div>
                            <div>
                ...
                <form className='w-[560px] mx-auto' onSubmit={handleSubmit(onsubmit)}>
                    <div className='flex items-center gap-4 bg-black/10 my-5 rounded-full px-4 py-4 pointer-events-none'>
                        ...
                        <span className='font-medium text-black/80'>ln.shopon</span>
                    </div>
